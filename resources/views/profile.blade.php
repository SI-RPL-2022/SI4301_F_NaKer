    ...
    <div class="row row-cols-1 row-cols-md-3 g-4" style="padding-top : 0.5cm">
        <div class="col">
            <div class="card text-center">
                ...
                <div class="card-body">
                    <h5 class="card-text">Faizal Eric Paradita</h5>
            ...
            <div class="card">
                <div class="card-body" style="background-color: #344E41; color: white; border-radius: 5%;">
                    <form class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label for="inputLinkedin" class="form-label">Curriculum Vitae</label>
                            <input type="file" class="form-control" id="inputLinkedin">
                        </div>
                    </form>
                </div>
            </div>
